...
| `versions/` | Frozen builds: v12 to v14 from the ChatGPT sessions, v15 and v16 as shipped, `v17-chatgpt` and `v18-chatgpt` raw drops (forked from v14, no co-op layers), v18 as shipped, `v19-chatgpt` (built on shipped v18), 19.5 and 19.6 as shipped. Kept for diffing and regression hunting. |
