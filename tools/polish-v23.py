"""Build index.html for v23: ChatGPT's v23 drop (versions/dead_ends_v23-chatgpt.html),
built on its v22.1, which descends from our shipped v19.6 (tracer fix, L4D safehouse door
...
SRC = ROOT / 'versions' / 'dead_ends_v23-chatgpt.html'
DST = ROOT / 'index.html'
